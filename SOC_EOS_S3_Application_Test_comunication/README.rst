QORC "EOS S3" Application for test of comunication between FPGA and MCU parts of SoC
====================================================================================


Intro
-----
This is application code (both parts: FPGA and MCU ARM) testing comunication between
FPGA and MCU parts using "Wishbone Bus" to "AHB Bus" bridge
This combines FPGA Designs into one, and makes all of them accessible over the 
AHB2WB interface - exposing the addresses as simple AHB addresses that the M4 
can write/read.
This also demonstrates the usage of the Interrupt mechanism from the FPGA to the M4 )
and how the M4 code can be setup to configure and handle the interrupts.
